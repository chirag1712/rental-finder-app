...
CREATE TABLE Posting(
  ...
  rooms_available TINYINT CONSTRAINT rooms_positive CHECK(rooms_available IS NULL OR rooms_available > 0),
  total_rooms TINYINT CONSTRAINT total_rooms_positive CHECK(total_rooms IS NULL OR total_rooms > 0),
  ac BOOLEAN,
  washrooms TINYINT CONSTRAINT washrooms_positive CHECK(washrooms IS NULL OR washrooms > 0),
  wifi BOOLEAN,
  parking BOOLEAN,
